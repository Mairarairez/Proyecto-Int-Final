...
@CrossOrigin(origins = "*")
//@CrossOrigin(origins = "http://localhost:4200")//4200 es del front 
//@CrossOrigin(origins = 
...
public class CExperiencia {
    ...
    //trae la lista
    @GetMapping("/lista")
    public ResponseEntity<List<Experiencia>> list(){ //trae la lista con las experiencias
    ...
    public ResponseEntity<?> create(@RequestBody dtoExperiencia dtoexp){      
        ...
        Experiencia experiencia = new Experiencia(dtoexp.getNombreE(), dtoexp.getDescripcionE()); //cremoa sun objeto de tipo experiencia
